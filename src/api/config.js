...
export const endpoints = {
    ...
    users: {
        ...
        avatarImage: (id) => `${API_BASE_URL}/users/${id}/avatar-image`,
    ...
    events: {
        ...
        coverImage: (id) => `${API_BASE_URL}/events/${id}/cover-image`,
        ...
        teamRequestAccept: (eventId, teamId, requestId) => `${API_BASE_URL}/events/${eventId}/teams/${teamId}/requests/${requestId}/accept`,
        teamRequestDecline: (eventId, teamId, requestId) => `${API_BASE_URL}/events/${eventId}/teams/${teamId}/requests/${requestId}/decline`,
        ...
        practiceState: (eventId, activityId) => `${API_BASE_URL}/events/${eventId}/activities/${activityId}/practice-state`,
        practiceStart: (eventId, activityId) => `${API_BASE_URL}/events/${eventId}/activities/${activityId}/practice/start`,
        practiceType: (eventId, activityId) => `${API_BASE_URL}/events/${eventId}/activities/${activityId}/practice/type`,
        practiceReset: (eventId, activityId) => `${API_BASE_URL}/events/${eventId}/activities/${activityId}/practice/reset`,
